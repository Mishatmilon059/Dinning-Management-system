...
}> = ({ allowedRoles, currentUser, children }) => {
        ...
        <div className="flex-1 pt-[68px]">
          <Routes>
            ...
            <Route 
              path="/" 
              element={
                <ProtectedRoute allowedRoles={["student", "manager"]} currentUser={currentUser}>
                  <StudentPortal 
                    addToast={addToast} 
                    lang={lang}
                    activeTab={activeTab}
            ...
            <Route 
              ...
              element={
                currentUser ? (
                  currentUser.role === "manager" ? <Navigate to="/manager" replace /> : <Navigate to="/" replace />
                ) : (
            ...
            <Route 
              path="/manager" 
              element={
                <ProtectedRoute allowedRoles={["manager"]} currentUser={currentUser}>
                  <ManagerPortal 
                    currentUser={currentUser} 
                    addToast={addToast} 
